...
public class PublishWS {
    public static void main(String[] args) {
        ...
        Endpoint MTLendpoint = Endpoint.publish("http://localhost:6231/MTLServer", new WebServerImpl());
        Endpoint LVLendpoint = Endpoint.publish("http://localhost:6231/LVLServer", new WebServerImpl());
